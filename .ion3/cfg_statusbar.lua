...
mod_statusbar.create{
    ...
    -- windows and icons.
    --
   template="[ %date || load: %load_1min | batt: %laptopstatus_batterypercent/%laptopstatus_batterytimeleft | CPU: %laptopstatus_cpuspeed %laptopstatus_temperature ] [%wsname] %filler%systray",
