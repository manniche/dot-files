...
&& ret=0
    ...
    (pip)
        ...
        case $line[1] in
            (compile)
_arguments "${_arguments_options[@]}" : \
'*-c+[Constrain versions using the given requirements files]:CONSTRAINT:_default' \
'*--constraint=[Constrain versions using the given requirements files]:CONSTRAINT:_default' \
'*--override=[Override versions using the given requirements files]:OVERRIDE:_default' \
'*-b+[Constrain build dependencies using the given requirements files when building source distributions]:BUILD_CONSTRAINT:_default' \
'*--build-constraint=[Constrain build dependencies using the given requirements files when building source distributions]:BUILD_CONSTRAINT:_default' \
...
'*-b+[Constrain build dependencies using the given requirements files when building distributions]:BUILD_CONSTRAINT:_default' \
'*--build-constraint=[Constrain build dependencies using the given requirements files when building distributions]:BUILD_CONSTRAINT:_default' \
