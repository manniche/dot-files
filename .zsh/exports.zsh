...
export PATH=~/.bin:/usr/local/opt/ruby193/bin:/usr/local/sbin:/usr/local/bin:/usr/local/share/npm/bin:/usr/local/share/python/:/sbin:$HOME/opt/local/bin:$HOME/opt/bin:$CLOJURE_HOME:/opt/sqldeveloper:$HOME/.local/bin:$PATH
